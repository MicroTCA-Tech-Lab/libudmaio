...
\DoxyCodeLine{40 }
\DoxyCodeLine{41     \textcolor{keywordtype}{void} \mbox{\hyperlink{classudmaio_1_1_fpga_mem_buffer_over_axi_a141bf386389f4078b954ed9388925f03}{copy\_from\_buf}}(\textcolor{keyword}{const} \mbox{\hyperlink{structudmaio_1_1_uio_region}{UioRegion}}\& buf\_info, std::vector<uint8\_t>\& out)\textcolor{keyword}{ const override }\{}
\DoxyCodeLine{42         BOOST\_LOG\_SEV(\mbox{\hyperlink{classudmaio_1_1_uio_if_a455a6630db927accf88d12d5b838d90f}{\_slg}}, blt::severity\_level::trace)}
\DoxyCodeLine{43             << \textcolor{stringliteral}{"{}FpgaMemBufferOverAxi: copy\_from\_buf: buf\_info.addr = 0x"{}} << std::hex}
\DoxyCodeLine{44             << buf\_info.\mbox{\hyperlink{structudmaio_1_1_uio_region_aeae3c222eaf007b2850693dfdfd3af9c}{addr}} << std::dec;}
\DoxyCodeLine{45         BOOST\_LOG\_SEV(\mbox{\hyperlink{classudmaio_1_1_uio_if_a455a6630db927accf88d12d5b838d90f}{\_slg}}, blt::severity\_level::trace)}
\DoxyCodeLine{46             << \textcolor{stringliteral}{"{}FpgaMemBufferOverAxi: copy\_from\_buf: buf\_info.size = "{}} << buf\_info.\mbox{\hyperlink{structudmaio_1_1_uio_region_ac820f3588c55f13155345aae9e198a32}{size}};}
\DoxyCodeLine{47         \textcolor{keywordtype}{size\_t} old\_size = out.size();}
\DoxyCodeLine{48         \textcolor{keywordtype}{size\_t} new\_size = old\_size + buf\_info.\mbox{\hyperlink{structudmaio_1_1_uio_region_ac820f3588c55f13155345aae9e198a32}{size}};}
\DoxyCodeLine{49         uintptr\_t mmap\_addr = buf\_info.\mbox{\hyperlink{structudmaio_1_1_uio_region_aeae3c222eaf007b2850693dfdfd3af9c}{addr}} -\/ \mbox{\hyperlink{classudmaio_1_1_uio_if_a7b9d1b5562353fb0df19cc5c4c447458}{\_region}}.\mbox{\hyperlink{structudmaio_1_1_uio_region_aeae3c222eaf007b2850693dfdfd3af9c}{addr}};}
\DoxyCodeLine{50         out.resize(new\_size);}
\DoxyCodeLine{51         std::memcpy(out.data() + old\_size, \textcolor{keyword}{static\_cast<}uint8\_t*\textcolor{keyword}{>}(\mbox{\hyperlink{classudmaio_1_1_uio_if_a9284f47ea82fd29ee29b3dfd9f465a73}{\_mem}}) + mmap\_addr, buf\_info.\mbox{\hyperlink{structudmaio_1_1_uio_region_ac820f3588c55f13155345aae9e198a32}{size}});}
\DoxyCodeLine{52     \}}
\DoxyCodeLine{53 \};}
\DoxyCodeLine{54 }
\DoxyCodeLine{55 \}  \textcolor{comment}{// namespace udmaio}}
