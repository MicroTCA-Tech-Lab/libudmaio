...
\DoxyCodeLine{45 }
\DoxyCodeLine{46     \mbox{\hyperlink{structudmaio_1_1_uio_device_info_a0abec63d551197a030d1926d63ce6563}{UioDeviceInfo}}(std::string \mbox{\hyperlink{structudmaio_1_1_uio_device_info_aacdc0c53739791ff68be0e1162e2bd43}{dev\_path}},}
...
\DoxyCodeLine{51     \mbox{\hyperlink{structudmaio_1_1_uio_device_info_ac58dd33243598679dbc68ee27c535b8a}{UioDeviceInfo}}(\mbox{\hyperlink{classudmaio_1_1_uio_device_location}{UioDeviceLocation}} dev\_loc);}
\DoxyCodeLine{52 \};}
\DoxyCodeLine{53 }
...
\DoxyCodeLine{59 }
\DoxyCodeLine{60     \textcolor{keyword}{static} std::unique\_ptr<UioConfigBase> \mbox{\hyperlink{classudmaio_1_1_uio_device_location_aa21d77ab0495f83970ebb4a21e005c07}{\_link\_cfg}};}
\DoxyCodeLine{61 }
...
\DoxyCodeLine{71 }
\DoxyCodeLine{73     \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{classudmaio_1_1_uio_device_location_a8b3f26fe787c85cb211ef63a7ddf5cd0}{set\_link\_axi}}();}
\DoxyCodeLine{74 }
\DoxyCodeLine{79     \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{classudmaio_1_1_uio_device_location_a1c02d1e2b02694389ab75aa1e65426dd}{set\_link\_xdma}}(std::string xdma\_path, uintptr\_t pcie\_offs, \textcolor{keywordtype}{bool} x7\_series\_mode);}
\DoxyCodeLine{80 }
...
\DoxyCodeLine{103     \textcolor{keyword}{static} \textcolor{keywordtype}{int} \mbox{\hyperlink{classudmaio_1_1_uio_config_uio_ab8a8469e1ddd2b858321b7ae8dd64f5d}{\_get\_uio\_number}}(std::string\_view name);}
\DoxyCodeLine{104     \textcolor{keyword}{static} \mbox{\hyperlink{structudmaio_1_1_uio_region}{UioRegion}} \mbox{\hyperlink{classudmaio_1_1_uio_config_uio_adce1eecf4e1271f76823374191eed627}{\_get\_map\_region}}(\textcolor{keywordtype}{int} uio\_number, \textcolor{keywordtype}{int} map\_index);}
\DoxyCodeLine{105 }
...
\DoxyCodeLine{111     \mbox{\hyperlink{structudmaio_1_1_uio_device_info}{UioDeviceInfo}} \mbox{\hyperlink{classudmaio_1_1_uio_config_uio_aafd48c47331586053028f554a80b977f}{operator()}}(\mbox{\hyperlink{classudmaio_1_1_uio_device_location}{UioDeviceLocation}} dev\_loc) \textcolor{keyword}{override};}
...
\DoxyCodeLine{123 }
\DoxyCodeLine{127     \mbox{\hyperlink{classudmaio_1_1_uio_config_xdma_af1fefcc5dc507f93e77d08ce1d878d24}{UioConfigXdma}}(std::string xdma\_path, uintptr\_t pcie\_offs, \textcolor{keywordtype}{bool} x7\_series\_mode = \textcolor{keyword}{false});}
\DoxyCodeLine{128 }
...
\DoxyCodeLine{134     \mbox{\hyperlink{structudmaio_1_1_uio_device_info}{UioDeviceInfo}} \mbox{\hyperlink{classudmaio_1_1_uio_config_xdma_a33fc547687ace9d054aa227d141ed3ea}{operator()}}(\mbox{\hyperlink{classudmaio_1_1_uio_device_location}{UioDeviceLocation}} dev\_loc) \textcolor{keyword}{override};}
