...
\DoxyCodeLine{43     \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{classudmaio_1_1_uio_if_a561f0715c14b47fcd87d6e67f824a494}{setLinkAxi}}();}
\DoxyCodeLine{44 }
\DoxyCodeLine{48     \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{classudmaio_1_1_uio_if_a3f30ddd6c04243ef503fc84522dd3756}{setLinkXdma}}(std::string xdma\_path, uintptr\_t pcie\_offs);}
\DoxyCodeLine{49 }
\DoxyCodeLine{52     \textcolor{keyword}{explicit} \mbox{\hyperlink{classudmaio_1_1_uio_if_a9eab72c96cad2df0a438ef2fcf685e2e}{UioIf}}(\mbox{\hyperlink{structudmaio_1_1_uio_device_info}{UioDeviceInfo}} dev);}
\DoxyCodeLine{53 }
\DoxyCodeLine{56     \textcolor{keyword}{explicit} \mbox{\hyperlink{classudmaio_1_1_uio_if_a93fbd9e04e08851d2588a9cbabb2d401}{UioIf}}(\mbox{\hyperlink{structudmaio_1_1_uio_device_location}{UioDeviceLocation}} dev\_loc);}
\DoxyCodeLine{57 }
\DoxyCodeLine{58     \textcolor{keyword}{virtual} \mbox{\hyperlink{classudmaio_1_1_uio_if_ac50743264269138365856bf6cf073273}{\string~UioIf}}();}
\DoxyCodeLine{59 }
\DoxyCodeLine{60   \textcolor{keyword}{protected}:}
\DoxyCodeLine{61     \textcolor{keyword}{static} std::unique\_ptr<UioConfigBase> \mbox{\hyperlink{classudmaio_1_1_uio_if_abd41c5a905eb15e80b0a69679e0233c7}{\_link\_cfg}};}
\DoxyCodeLine{62 }
\DoxyCodeLine{66     \textcolor{keyword}{static} \mbox{\hyperlink{structudmaio_1_1_uio_device_info}{UioDeviceInfo}} \mbox{\hyperlink{classudmaio_1_1_uio_if_acaef7f066d84ab8469d3a321b1208159}{\_dev\_info\_from\_dev\_loc}}(\mbox{\hyperlink{structudmaio_1_1_uio_device_location}{UioDeviceLocation}} dev\_loc);}
\DoxyCodeLine{67 }
