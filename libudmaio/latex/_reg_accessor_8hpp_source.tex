...
\DoxyCodeLine{24 }
\DoxyCodeLine{30     C \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_ac48b43f437837cd965706d4c7626b2b9}{\_rd}}(uint32\_t offs)\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_a4067a4efbfab68504bf00063b389eb93}{\_if}}-\/>template \_rd\_reg<C>(offs); \}}
\DoxyCodeLine{31 }
\DoxyCodeLine{37     \textcolor{keywordtype}{void} \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_a7107c7f25cb16b638ae56903c7803837}{\_wr}}(uint32\_t offs, \textcolor{keyword}{const} C\& value) \{ \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_a4067a4efbfab68504bf00063b389eb93}{\_if}}-\/>template \_wr\_reg<C>(offs, value); \}}
\DoxyCodeLine{38 }
\DoxyCodeLine{39   \textcolor{keyword}{public}:}
\DoxyCodeLine{40     \textcolor{keyword}{using }\mbox{\hyperlink{classudmaio_1_1_uio_if}{constructor\_arg\_type}} = \mbox{\hyperlink{classudmaio_1_1_uio_if}{UioIf}}*;}
\DoxyCodeLine{41 }
\DoxyCodeLine{42     \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_ad878857665ec6cb11fb5133240a23e65}{RegAccessorBase}}() = \textcolor{keyword}{delete};}
\DoxyCodeLine{43 }
\DoxyCodeLine{48     \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_a7298226a53b233dd99ca2dec3e41d109}{RegAccessorBase}}(\mbox{\hyperlink{classudmaio_1_1_uio_if}{constructor\_arg\_type}} interface) : \mbox{\hyperlink{classudmaio_1_1_reg_accessor_base_a4067a4efbfab68504bf00063b389eb93}{\_if}}\{interface\} \{\}}
\DoxyCodeLine{49 \};}
\DoxyCodeLine{50 }
